...
| תאים עם מקור מוצג | 314 (87%) |
| תאים שנבדקו ולא נמצאה בהם אמירה פומבית | 46 (13%) |
| תאים שטרם נחקרו | 0 |
| רשומות מקור מאומתות | 793 |
...
| `data/sources.json` | 793 רשומות המקור עם הציטוט המילולי, וכן התאים שנבדקו ונמצאו ריקים |
...
> מצפן הבחירות 2026, גרסת נתונים 2026-09-15. https://bhirot26.online · https://github.com/dangelm/bhirot26-election-data
...
- **אינו שלם.** ב-46 תאים חיפשנו ולא מצאנו אמירה פומבית. הם מסומנים ככאלה ולא
...
18 parties × 20 issues = 360 coded positions. 314 carry a
published primary source with a verbatim quote, a date and a link; 46 are cells where we
